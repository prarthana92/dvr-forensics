...
def extract_frames(video_path, output_folder, interval_seconds=1):
    ...
    while True:
        ...
        if frame_number % frame_interval == 0:
            ...
            filename = os.path.join(output_folder, f"frame_{saved_count + 1:03d}.jpg")
    ...
    index_path = os.path.join(output_folder, "frame_index.json")
    with open(index_path, "w", encoding="utf-8") as file:
        json.dump(frame_index, file, indent=4)
